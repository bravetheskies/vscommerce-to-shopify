...
function lookup_country($country) {
    ...
    if (array_key_exists((string)$country, $country_lookup)) {
        return $country_lookup[(string)$country];echo "YES";
    } else {
        return $country;
    }
}
...
function code_to_country( $code ){
    ...
    $countryList = get_country_code_array();
...
function country_name_to_code( $country_name ){
    ...
    $country_list = get_country_code_array();

    foreach ($country_list as $code => $name) {
        if ($country_name == strtoupper($name)) {
            return $code;
        }
    }
...
function get_country_code_array() {
    return array(
        'AF' => 'Afghanistan',
        'AX' => 'Aland Islands',
        'AL' => 'Albania',
